...
namespace Library_Management {
    ...
    public partial class LibraryManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class MemberDataTable : global::System.Data.TypedTableBase<MemberRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public MemberRow AddMemberRow(int ID, string Roll_No, string Name, string Branch, string Semester, string Address) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public MemberRow FindByRoll_No(string Roll_No) {
...
namespace Library_Management.LibraryManagementDataSetTableAdapters {
    ...
    public partial class MemberTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Member] WHERE (([ID] = @Original_ID) AND ([Roll_No] = @Origina" +
                "l_Roll_No) AND ([Name] = @Original_Name) AND ([Branch] = @Original_Branch) AND (" +
                "[Semester] = @Original_Semester))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([ID], [Roll_No], [Name], [Branch], [Semester], [Addre" +
                "ss]) VALUES (@ID, @Roll_No, @Name, @Branch, @Semester, @Address);\r\nSELECT ID, Ro" +
                "ll_No, Name, Branch, Semester, Address FROM Member WHERE (Roll_No = @Roll_No)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Member] SET [ID] = @ID, [Roll_No] = @Roll_No, [Name] = @Name, [Branch] = @Branch, [Semester] = @Semester, [Address] = @Address WHERE (([ID] = @Original_ID) AND ([Roll_No] = @Original_Roll_No) AND ([Name] = @Original_Name) AND ([Branch] = @Original_Branch) AND ([Semester] = @Original_Semester));
SELECT ID, Roll_No, Name, Branch, Semester, Address FROM Member WHERE (Roll_No = @Roll_No)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Roll_No, Name, Branch, Semester, Address FROM dbo.Member";
        ...
        public virtual int Delete(int Original_ID, string Original_Roll_No, string Original_Name, string Original_Branch, string Original_Semester) {
        ...
        public virtual int Insert(int ID, string Roll_No, string Name, string Branch, string Semester, string Address) {
        ...
        public virtual int Update(int ID, string Roll_No, string Name, string Branch, string Semester, string Address, int Original_ID, string Original_Roll_No, string Original_Name, string Original_Branch, string Original_Semester) {
            ...
            if ((Original_Roll_No == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Roll_No));
            }
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ID, string Name, string Branch, string Semester, string Address, int Original_ID, string Original_Roll_No, string Original_Name, string Original_Branch, string Original_Semester) {
            return this.Update(ID, Original_Roll_No, Name, Branch, Semester, Address, Original_ID, Original_Roll_No, Original_Name, Original_Branch, Original_Semester);
        }
    }
