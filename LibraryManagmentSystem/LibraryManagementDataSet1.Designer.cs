...
namespace Library_Management {
    ...
    public partial class LibraryManagementDataSet1 : global::System.Data.DataSet {
        ...
        public partial class MemberDataTable : global::System.Data.TypedTableBase<MemberRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public MemberRow AddMemberRow(int ID, string Name, string Roll_No, string Branch, string Semester, string Address) {
        ...
        public partial class MemberRow : global::System.Data.DataRow {
            ...
            public string Roll_No {
                get {
                    return ((string)(this[this.tableMember.Roll_NoColumn]));
                }
                set {
                    this[this.tableMember.Roll_NoColumn] = value;
                }
            }
            ...
            public string Semester {
                get {
                    return ((string)(this[this.tableMember.SemesterColumn]));
                }
                set {
                    this[this.tableMember.SemesterColumn] = value;
                }
            }
...
namespace Library_Management.LibraryManagementDataSet1TableAdapters {
    ...
    public partial class MemberTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Member] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_N" +
                "ame) AND ([Roll_No] = @Original_Roll_No) AND ([Branch] = @Original_Branch) AND (" +
                "[Semester] = @Original_Semester) AND ([Address] = @Original_Address))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([ID], [Name], [Roll_No], [Branch], [Semester], [Addre" +
                "ss]) VALUES (@ID, @Name, @Roll_No, @Branch, @Semester, @Address);\r\nSELECT ID, Na" +
                "me, Roll_No, Branch, Semester, Address FROM Member WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Member] SET [ID] = @ID, [Name] = @Name, [Roll_No] = @Roll_No, [Branch] = @Branch, [Semester] = @Semester, [Address] = @Address WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Roll_No] = @Original_Roll_No) AND ([Branch] = @Original_Branch) AND ([Semester] = @Original_Semester) AND ([Address] = @Original_Address));
SELECT ID, Name, Roll_No, Branch, Semester, Address FROM Member WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Roll_No, Branch, Semester, Address FROM dbo.Member";
        ...
        public virtual int Fill(LibraryManagementDataSet1.MemberDataTable dataTable) {
        ...
        public virtual LibraryManagementDataSet1.MemberDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryManagementDataSet1.MemberDataTable dataTable = new LibraryManagementDataSet1.MemberDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryManagementDataSet1.MemberDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
        ...
        public virtual int Insert(int ID, string Name, string Roll_No, string Branch, string Semester, string Address) {
        ...
        public virtual int Update(int ID, string Name, string Roll_No, string Branch, string Semester, string Address, int Original_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Roll_No, string Branch, string Semester, string Address, int Original_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
            return this.Update(Original_ID, Name, Roll_No, Branch, Semester, Address, Original_ID, Original_Name, Original_Roll_No, Original_Branch, Original_Semester, Original_Address);
        }
    }
