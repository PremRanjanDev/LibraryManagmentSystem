...
namespace Library_Management {
    ...
    public partial class LibraryManagementDataSet4 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public BooksRow AddBooksRow(string Book_ID, string Name, string Author, string Type, string Publisher) {
...
namespace Library_Management.LibraryManagementDataSet4TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([Book_ID] = @Original_Book_ID) AND ([Name] = @O" +
                "riginal_Name) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Ori" +
                "ginal_Author)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Book_ID], [Name], [Author], [Type], [Publisher]) VALU" +
                "ES (@Book_ID, @Name, @Author, @Type, @Publisher);\r\nSELECT Book_ID, Name, Author," +
                " Type, Publisher FROM Books WHERE (Book_ID = @Book_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Book_ID] = @Book_ID, [Name] = @Name, [Author] = @Author, [Type] = @Type, [Publisher] = @Publisher WHERE (([Book_ID] = @Original_Book_ID) AND ([Name] = @Original_Name) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)));
SELECT Book_ID, Name, Author, Type, Publisher FROM Books WHERE (Book_ID = @Book_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Book_ID, Name, Author, Type, Publisher FROM dbo.Books";
        ...
        public virtual int Fill(LibraryManagementDataSet4.BooksDataTable dataTable) {
        ...
        public virtual LibraryManagementDataSet4.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryManagementDataSet4.BooksDataTable dataTable = new LibraryManagementDataSet4.BooksDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryManagementDataSet4.BooksDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Book_ID, string Original_Name, string Original_Author) {
        ...
        public virtual int Insert(string Book_ID, string Name, string Author, string Type, string Publisher) {
            if ((Book_ID == null)) {
        ...
        public virtual int Update(string Book_ID, string Name, string Author, string Type, string Publisher, string Original_Book_ID, string Original_Name, string Original_Author) {
            if ((Book_ID == null)) {
                throw new global::System.ArgumentNullException("Book_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Author, string Type, string Publisher, string Original_Book_ID, string Original_Name, string Original_Author) {
            return this.Update(Original_Book_ID, Name, Author, Type, Publisher, Original_Book_ID, Original_Name, Original_Author);
        }
    }
