...
namespace Library_Management {
    ...
    public partial class LibraryManagementDataSet3 : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public MembersRow AddMembersRow(int Member_ID, string Name, string Roll_No, string Branch, string Semester, string Address) {
        ...
        public partial class MembersRow : global::System.Data.DataRow {
            ...
            public string Roll_No {
                get {
                    return ((string)(this[this.tableMembers.Roll_NoColumn]));
                }
                set {
                    this[this.tableMembers.Roll_NoColumn] = value;
                }
            }
            ...
            public string Semester {
                get {
                    return ((string)(this[this.tableMembers.SemesterColumn]));
                }
                set {
                    this[this.tableMembers.SemesterColumn] = value;
                }
            }
...
namespace Library_Management.LibraryManagementDataSet3TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Members] WHERE (([Member_ID] = @Original_Member_ID) AND ([Name" +
                "] = @Original_Name) AND ([Roll_No] = @Original_Roll_No) AND ([Branch] = @Origina" +
                "l_Branch) AND ([Semester] = @Original_Semester) AND ([Address] = @Original_Addre" +
                "ss))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Members] ([Member_ID], [Name], [Roll_No], [Branch], [Semester], [Address]) VALUES (@Member_ID, @Name, @Roll_No, @Branch, @Semester, @Address);
SELECT Member_ID, Name, Roll_No, Branch, Semester, Address FROM Members WHERE (Member_ID = @Member_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [Member_ID] = @Member_ID, [Name] = @Name, [Roll_No] = @Roll_No, [Branch] = @Branch, [Semester] = @Semester, [Address] = @Address WHERE (([Member_ID] = @Original_Member_ID) AND ([Name] = @Original_Name) AND ([Roll_No] = @Original_Roll_No) AND ([Branch] = @Original_Branch) AND ([Semester] = @Original_Semester) AND ([Address] = @Original_Address));
SELECT Member_ID, Name, Roll_No, Branch, Semester, Address FROM Members WHERE (Member_ID = @Member_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Member_ID, Name, Roll_No, Branch, Semester, Address FROM dbo.Members";
        ...
        public virtual int Fill(LibraryManagementDataSet3.MembersDataTable dataTable) {
        ...
        public virtual LibraryManagementDataSet3.MembersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryManagementDataSet3.MembersDataTable dataTable = new LibraryManagementDataSet3.MembersDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryManagementDataSet3.MembersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Member_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
        ...
        public virtual int Insert(int Member_ID, string Name, string Roll_No, string Branch, string Semester, string Address) {
        ...
        public virtual int Update(int Member_ID, string Name, string Roll_No, string Branch, string Semester, string Address, int Original_Member_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Roll_No, string Branch, string Semester, string Address, int Original_Member_ID, string Original_Name, string Original_Roll_No, string Original_Branch, string Original_Semester, string Original_Address) {
            return this.Update(Original_Member_ID, Name, Roll_No, Branch, Semester, Address, Original_Member_ID, Original_Name, Original_Roll_No, Original_Branch, Original_Semester, Original_Address);
        }
    }
